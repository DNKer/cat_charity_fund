...
# «Пустой» роутер для модели Reservation:
router = APIRouter()
...
@router.get(
    ...
    description='Получить список всех `зарезервированных` переговорок.'
)
...
@router.delete(
    '/{reservation_id}',
    response_model=ReservationDB,
    description='Удалить `зарезервированную` переговорку.'
)
...
@router.get(
    ...
    description='Получить список всех моих `забронированных` переговорок.'
)
async def get_my_reservations(
    ...
    all_reservations = await reservation_crud.get_by_user(
